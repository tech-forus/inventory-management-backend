...
const transformOutgoingItem = (item) => {
  ...
  return {
    ...
    totalValue: parseFloat(item.total_value || item.total_incl_gst || 0),
    gstPercentage: parseFloat(item.gst_percentage || 0),
    gstAmount: parseFloat(item.gst_amount || 0),
    totalExclGst: parseFloat(item.total_excl_gst || 0),
    totalInclGst: parseFloat(item.total_incl_gst || item.total_value || 0),
    skuDiscount: parseFloat(item.sku_discount || 0),
    skuDiscountAmount: parseFloat(item.sku_discount_amount || 0),
    amountAfterSkuDiscount: parseFloat(item.amount_after_sku_discount || 0),
    invoiceDiscountShare: parseFloat(item.invoice_discount_share || 0),
    finalTaxableAmount: parseFloat(item.final_taxable_amount || 0),
