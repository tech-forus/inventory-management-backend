    ...
    for (let i = 0; i < data.length; i++) {
      ...
      try {
        ...
        const skuData = {
          ...
          itemDetails: getValue(row, 'item_details', 'itemDetails', 'Item Details', 'description', 'Description') || null,
          vendorId,
          vendorItemCode: getValue(row, 'vendor_item_code', 'vendorItemCode', 'Vendor Item Code') || null,
          brandId,
          hsnSacCode: getValue(row, 'hsn_sac_code', 'hsnSacCode', 'HSN Code', 'HSN', 'hsn') || null,
          ratingSize: getValue(row, 'rating_size', 'ratingSize', 'Rating Size', 'rating') || null,
          ...
          minStockLevel: getValue(row, 'min_stock_level', 'minStockLevel', 'Min Stock', 'min_stock') ? parseInt(getValue(row, 'min_stock_level', 'minStockLevel', 'Min Stock', 'min_stock')) : 0,
          ...
          defaultStorageLocation: getValue(row, 'default_storage_location', 'defaultStorageLocation', 'Storage Location') || null,
