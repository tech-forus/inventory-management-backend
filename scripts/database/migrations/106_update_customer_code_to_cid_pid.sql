-- Migration: 106_update_customer_code_to_cid_pid
-- Description: Updates the customer code format to use CID for existing and PID for potential
-- Example: FEPL/CID26/001
-- Created: 2026-02-27
...
BEGIN
    ...
    -- CID for Existing, PID for Potential
