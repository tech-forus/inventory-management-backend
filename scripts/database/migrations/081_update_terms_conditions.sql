-- Migration: Update Terms & Conditions (Variable-Rich Clauses & Fixed Clauses)
-- Description: Updates the terms_conditions table with enhanced legal clauses.
-- Date: 2026-02-17
